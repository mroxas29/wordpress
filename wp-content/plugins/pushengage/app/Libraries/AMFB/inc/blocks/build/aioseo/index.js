...
/***/ "./src/aioseo/block.json":
/*!*******************************!*\
  !*** ./src/aioseo/block.json ***!
  \*******************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"am/faux-aioseo","version":"0.1.0","category":"widgets","icon":"admin-plugins","supports":{"html":false},"textdomain":"all-in-one-seo-pack","editorScript":"file:./index.js","editorStyle":"file:./index.css"}');
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/aioseo/block.json");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_1__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_2__, {
  attributes: {
    ...
    pluginName: {
      type: 'string',
      default: 'All in One SEO'
    },
    pluginPath: {
      type: 'string',
      default: 'all-in-one-seo-pack/all_in_one_seo_pack.php'
    }
  },
  /**
   * @see ../edit.js
